...
import br.com.inf3cm.priceresearch.Product;
import br.com.inf3cm.priceresearch.ResetPassword;
import br.com.inf3cm.priceresearch.SingUpActivity;
import br.com.inf3cm.priceresearch.User;
import br.com.inf3cm.priceresearch.UserDao;
...
public class Login extends AppCompatActivity{
    ...
    String mStringUser, mStringSenha, mStringEmail, mStringApiKey, mStringIpV4, mStringNetwork;
    ...
    private void postData(){
        ...
        mStringSenha = String.valueOf(mEditTextPassword.getText());
        ...
        User mUser = new User(mStringSenha, mStringEmail);
...
//        android:focusableInTouchMode="true"
        ...
        mTextViewNetworkIp = findViewById(R.id.textView_forgot_password);
