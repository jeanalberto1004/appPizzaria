...
public class SingUpActivity extends AppCompatActivity {
    ...
    private void postData() {
        ...
        User mUser = new User(mStringTelefone, mStringCep, mStringsenha, mStringEmail, mStringNome, mStringLongradouro, mStringCidade, mStringBairro, mStringNumeroResid, mStringComplemento, System.currentTimeMillis());
